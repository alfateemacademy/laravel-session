...
<div class="header navbar navbar-inverse "> 
  ...
  <div class="navbar-inner">
	<div class="header-seperation"> 
      ...
      <!-- BEGIN LOGO -->	
      <a href="index.html"><img src="/assets/admin/img/logo.png" class="logo" alt=""  data-src="/assets/admin/img/logo.png" data-src-retina="/assets/admin/img/logo2x.png" width="106" height="21"/></a>
      <!-- END LOGO --> 
					...
					<div style="width:300px">
						  <div class="notification-messages info">
							...
							<div class="notification-messages success">
								<div class="user-profile">
									<img src="/assets/admin/img/profiles/h.jpg"  alt="" data-src="/assets/admin/img/profiles/h.jpg" data-src-retina="/assets/admin/img/profiles/h2x.jpg" width="35" height="35">
								</div>
								<div class="message-wrapper">
									<div class="heading">
	...
	<div class="chat-window-wrapper fadeIn" id="chat-users" >
		...
		<div class="side-widget fadeIn">
		   ...
		   <div id="favourites-list">
		    <div class="side-widget-content" >
				<div class="user-details-wrapper active" data-chat-status="online" data-chat-user-pic="/assets/admin/img/profiles/d.jpg" data-chat-user-pic-retina="/assets/admin/img/profiles/d2x.jpg" data-user-name="Jane Smith">
					<div class="user-profile">
						<img src="/assets/admin/img/profiles/d.jpg"  alt="" data-src="/assets/admin/img/profiles/d.jpg" data-src-retina="/assets/admin/img/profiles/d2x.jpg" width="35" height="35">
					</div>
					<div class="user-details">
				...
				<div class="user-details-wrapper" data-chat-status="busy" data-chat-user-pic="/assets/admin/img/profiles/d.jpg" data-chat-user-pic-retina="/assets/admin/img/profiles/d2x.jpg" data-user-name="David Nester">
					<div class="user-profile">
						<img src="/assets/admin/img/profiles/c.jpg"  alt="" data-src="/assets/admin/img/profiles/c.jpg" data-src-retina="/assets/admin/img/profiles/c2x.jpg" width="35" height="35">
					</div>
					<div class="user-details">
						<div class="user-name">
						David Nester
		...
		<div class="side-widget">
		   <div class="side-widget-title">more friends</div>
			 <div class="side-widget-content" id="friends-list">
				<div class="user-details-wrapper" data-chat-status="online" data-chat-user-pic="/assets/admin/img/profiles/d.jpg" data-chat-user-pic-retina="/assets/admin/img/profiles/d2x.jpg" data-user-name="Jane Smith">
					<div class="user-profile">
						<img src="/assets/admin/img/profiles/d.jpg"  alt="" data-src="/assets/admin/img/profiles/d.jpg" data-src-retina="/assets/admin/img/profiles/d2x.jpg" width="35" height="35">
					</div>
					<div class="user-details">
